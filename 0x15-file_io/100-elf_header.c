...
/**
 * print_magic - a function that prints the magic nmbrs of an ELF header.
 ...
 * @e_ident: pointer an array that contain the ELF version.
 */
void print_version(unsigned char *e_ident)
{
	printf("  Version:                           %d",
...
/**
 * print_osabi - function that prints OS/ABI of an ELF header.
 * @e_ident: pointer to array that contain the ELF version.
 */
void print_osabi(unsigned char *e_ident)
{
	printf("  OS/ABI:                            ");
 ...
 * @e_ident: pointer to array that contain the ELF ABI version.
 */
void print_abi(unsigned char *e_ident)
{
...
/**
 * main - function displaying  the infos contained
 *        in the ELF header
